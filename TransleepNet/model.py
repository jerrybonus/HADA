...
class MSNN_Feature_Embedding_Two_Way(nn.Module):
    def __init__(self):
        ...
        self.mha_ff_T = nn.TransformerEncoderLayer(112, 8, dim_feedforward=448)
        self.mha_ff_S = nn.TransformerEncoderLayer(112, 8, dim_feedforward=448)
